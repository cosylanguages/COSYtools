/**
 * COSYlanguages Standalone App — Deutsche Präpositionen & Kasus SRS Manager
 * Manages per-word mastery tracking (level 0–5), Leitner/SRS due dates, daily streaks,
 * progress dashboard matrices, and weak-spot deck in localStorage ("cosy-de-praepositionen-progress").
 */

class DePraepositionenSrsManager {
    constructor() {
        this.STORAGE_KEY = "cosy-de-praepositionen-progress";
    ...
    loadProgress() {
        try {
            ...
            console.error("Fehler beim Laden des SRS-Fortschritts:", e);
        }
    ...
    saveProgress() {
        try {
            ...
            console.error("Fehler beim Speichern des SRS-Fortschritts:", e);
        }
    }
...
if (typeof module !== 'undefined') {
    module.exports = DePraepositionenSrsManager;
}
